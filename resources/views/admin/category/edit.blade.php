          ...
          <div class="card-body">
            ...
            <form class="row g-3 needs-validation" method="post" action="{{ route('category.update') }}" novalidate>
              ...
              <div class="col-md-6">
                ...
                <input type="text" placeholder="type category name" class="form-control" id="validationCustom01" value="{{ $model->name }}" name="name" required>
              </div>
              <div class="col-md-6">
                ...
                <select name="status" class="form-select" id="validationCustom04" required>
                  ...
                  <option {{ $model->status == 'Inctive'?'selected':'' }} value="Inactive">Inactive</option>
                </select>
              </div>
